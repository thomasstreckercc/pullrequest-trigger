package de.codecentric.bitbucket.plugin.service;
...
public class BambooService {
    ...
    private final static Logger LOGGER = LoggerFactory.getLogger(BambooService.class);
    ...
    @Autowired
    public BambooService(AoRepositoryPlanDao repositoryPlanDao, AoPullRequestPlanDao pullrequestPlanDao,
    ...
    public void createAndLaunchPlanBranch(PullRequestEvent event) {
    ...
    public void deletePlanBranch(PullRequestEvent event) {
